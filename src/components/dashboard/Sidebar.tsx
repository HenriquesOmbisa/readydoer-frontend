...
export function Sidebar() {
  ...
  const quickActions = isClient 
      ? [
          ...
          { name: "Buscar Freelancers", icon: <Search className="w-4 h-4" />, href: "/hire" },
        ]
      : [
          { name: "Procurar Projetos", icon: <Search className="w-4 h-4" />, href: "/project" },
    ...
    <>
      ...
      <aside 
        className={`
          ...
          md:translate-x-0
          bg-background border-r flex flex-col h-screen transition-all duration-300 fixed md:sticky top-0 z-40
        `}
      >
        {/* Cabeçalho */}
