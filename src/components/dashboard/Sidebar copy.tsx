...
export function Sidebar() {
  ...
  const favorites = [
    { name: "Projetos Salvos", icon: <Heart className="w-4 h-4 text-red-500" />, href: "/saved" },
    { name: "Freelancers Favoritos", icon: <Star className="w-4 h-4 text-yellow-500" />, href: "/favorites" },
  ]
      ...
      <div className="p-4 border-b">
        ...
        {!collapsed && (
          <div className="relative mb-4">
            ...
            <Input 
              placeholder={isClient ? "Buscar freelancers..." : "Buscar projetos..."} 
              className="pl-10"
            />
          </div>
        )}
